                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://youtube.com/channel/UCWFBFVvushMYpuEvWkkUrXg'
                                }
                                }, {
                                urlButton: {
...
let btn = [{
            ...
            break
case 'gopay': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/958dce9d8198da96f99a1.jpg' }, caption: `Gopay` }, { quoted: m })
            }
            break
case 'dana': {
                xavior.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/aac285790dfe170859d87.jpg' }, caption: `DANA` }, { quoted: m })
            }
            break
case 'pulsa': {
